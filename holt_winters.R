...
for(loop in 1:n.teste){
  ...
  demanda_passada <- ts((passado), frequency = 12)
...
#Salva as previsões
save_path_injetada <-'K://DPCL//_Comum//Projeção de Energia Injetada//previsoes_injetada_univariados//holt_winters_injetada'
